...
const localizedPosts = {
  en: [
    ...
    { slug: "crypto-market", title: "Crypto Market Psychology", excerpt: "Understanding investor emotions in crypto cycles.", category: "Investment" },
    { slug: "global-liquidity", title: "Global Liquidity & Markets", excerpt: "Liquidity remains the foundation of market cycles.", category: "Macro" },
  ],
  tw: [
    { slug: "ai-semiconductor", title: "AI 與半導體戰略", excerpt: "AI 正在重塑全球半導體產業。", category: "科技" },
    { slug: "crypto-market", title: "加密市場心理學", excerpt: "理解加密市場週期中的投資者情緒。", category: "投資" },
    { slug: "global-liquidity", title: "全球流動性與市場", excerpt: "流動性始終是市場週期的核心。", category: "宏觀" },
  ],
  jp: [
    { slug: "ai-semiconductor", title: "AIと半導体戦略", excerpt: "AI は半導体産業を大きく変えつつある。", category: "テクノロジー" },
    { slug: "crypto-market", title: "暗号市場の心理学", excerpt: "暗号市場サイクルにおける投資家心理を理解する。", category: "投資" },
    { slug: "global-liquidity", title: "グローバル流動性と市場", excerpt: "流動性は市場サイクルの基盤である。", category: "マクロ" },
  ],
};
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Link
            href={`/${locale}`}
            className="text-white text-xl font-semibold tracking-[0.25em] transition hover:opacity-80"
          >
            WEALTH·SUPER
          </Link>
          ...
          <div className="flex items-center gap-4">
            <div className="hidden lg:block">
              <SearchModal
                posts={localizedPosts[locale as keyof typeof localizedPosts]}
                locale={locale}
              />
            </div>
            ...
            >
              <span className={`block h-[2px] w-6 bg-white transition-all ${menuOpen ? "rotate-45 translate-y-[7px]" : ""}`} />
